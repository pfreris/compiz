set (USE_MATECONF 1 CACHE BOOL "Install core MateConf schemas")
...
if (USE_MATECONF)
    ...
    if (NOT COMPIZ_INSTALL_MATECONF_SCHEMA_DIR)
        set (SCHEMADIR "${CMAKE_INSTALL_PREFIX}/share/mateconf/schemas")
    else (NOT COMPIZ_INSTALL_MATECONF_SCHEMA_DIR)
        set (SCHEMADIR "${COMPIZ_INSTALL_MATECONF_SCHEMA_DIR}")
    endif (NOT COMPIZ_INSTALL_MATECONF_SCHEMA_DIR)

    if (NOT MATECONF_FOUND OR NOT MATECONFTOOL_EXECUTABLE)
	set (USE_MATECONF 0)
    else ()
        include (CompizGconf)
...
function (_print_configure_results)
    ...
    compiz_print_result_message ("marco theme support" USE_MARCO)
    compiz_print_result_message ("mateconf schemas" USE_MATECONF)
    compiz_print_result_message ("mate" USE_MATE)
