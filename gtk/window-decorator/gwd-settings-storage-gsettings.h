...
GWDSettingsStorage *
gwd_settings_storage_gsettings_new (GSettings *orgMATEDesktopSettings,
...
extern const gchar * ORG_MATE_MUTTER;
extern const gchar * ORG_MATE_DESKTOP_WM_PREFERENCES;
